...
export const SOCIALS = {
  ...
  SCHOLAR: 'https://scholar.google.com/citations?hl=en&user=Ecj7W9YAAAAJ&view_op=list_works',
  LEETCODE: 'https://leetcode.com/u/uBiurrBBsV/',
}
...
export const SHOWCASE_REPOS = [
  'Vision-Based-Intelligent-Triage-and-Autonomous-Lifesign-Analytics',
